    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoWindow(final Marker marker) {
                ...
                afterLoad = (RelativeLayout) v.findViewById(R.id.afterLoad);
                ...
                getMarkerDetails(marker.getTitle(), marker.getPosition().latitude, marker.getPosition().longitude, new VolleyCallback() {
                    ...
                    public void onSuccess(JSONObject result) {
                        try {
                            ...
                            markerDetailsImage = result.getString("userImage");
                ...
                ImageView markerImage = (ImageView) v.findViewById(R.id.userImage);
                ...
                Picasso.with(getApplicationContext()).load(URL.URL_DOMAIN + URL.URL_RESOURCES + sessionManager.getProfileUser().getUserImage()).into(markerImage);
